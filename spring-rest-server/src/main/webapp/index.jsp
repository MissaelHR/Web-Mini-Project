    ...
    <main role="main">
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          <h2 class="display-5">Server REST</h2>
          <p>Este mini proyecto ha tomado los datos CSV de una inmobiliaria española que cuenta con los campos de "Tipo de inmueble",
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <h2>Client REST</h2>
            <p>Por favor da clic en el boton para ir al lado del cliente y poder observar la tabla de datos y los graficos correspondientes.</p>
            <p><a class="btn btn-secondary" href="/spring-rest-client" role="button">View details &raquo;</a></p>
          </div>
